...
forecast = pd.read_excel('great_recession_training.xlsx') #Importing data with pandas
...
for train_index, val_index in tss.split(X_train):
	...
	callbacks = [tf.keras.callbacks.ReduceLROnPlateau(monitor='loss', patience = 80),
	            ...
	            tf.keras.callbacks.CSVLogger('Great_recession_120TS_log'+str(z)+'.csv', append=True)]
...
#==========================================================================================
	...
	dataset_test = pd.read_excel('great_recession_testing.xlsx') #Imporing test data set
